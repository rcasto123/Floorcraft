    ...
    set((state) => {
      ...
      for (const e of newEmployees) {
        ...
        next[id] = {
          ...
          expectedReturnDate: e.expectedReturnDate ?? null,
          coverageEmployeeId: e.coverageEmployeeId ?? null,
          leaveNotes: e.leaveNotes ?? null,
          departureDate: e.departureDate ?? null,
          equipmentNeeds: e.equipmentNeeds || [],
          equipmentStatus: e.equipmentStatus || 'not-needed',
          photoUrl: e.photoUrl || null,
          tags: e.tags || [],
          accommodations: e.accommodations ?? [],
          sensitivityTags: e.sensitivityTags ?? [],
