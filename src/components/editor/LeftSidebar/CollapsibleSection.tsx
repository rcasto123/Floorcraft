  ...
  return (
    <div className="border-b border-[color:var(--color-paper-line)] dark:border-gray-800 last:border-b-0">
      <button
        ...
        // off the right edge.
        className="w-full flex items-center gap-1.5 px-3 py-2 font-mono text-[11px] font-medium uppercase tracking-[0.18em] text-gray-600 dark:text-gray-300 hover:bg-[color:var(--color-paper-sunken)] dark:hover:bg-gray-800/50 min-w-0"
      >
