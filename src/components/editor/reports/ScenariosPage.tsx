...
export function ScenariosPage() {
  ...
  if (!canView) {
    return (
      <div className="p-6 text-gray-600">Not authorized to view scenarios.</div>
    )
  }
  ...
  return (
    <div className="flex h-full min-h-[600px]">
      ...
      <aside className="w-64 border-r border-gray-200 bg-gray-50 p-4 flex flex-col gap-3">
        <div className="flex items-center justify-between">
          ...
          {canEdit && (
            <button
              ...
              className="text-xs px-2 py-1 border border-gray-200 bg-white rounded hover:bg-gray-100"
        ...
        <div className="mt-auto text-xs text-gray-500 border-t border-gray-200 pt-3">
      ...
      <div className="flex-1 flex flex-col">
        {active ? (
          ...
          >
            <Tabs.List className="flex items-center gap-1 border-b border-gray-200 px-6 pt-4">
              <Tabs.Trigger
                value="edit"
                className="px-3 py-2 text-sm text-gray-500 data-[state=active]:text-gray-900 data-[state=active]:border-b-2 data-[state=active]:border-blue-500 -mb-px"
              >
                Edit
              </Tabs.Trigger>
              <Tabs.Trigger
