  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div>
        ...
        <input
          className="w-full text-sm border border-gray-200 dark:border-gray-800 rounded px-2 py-1.5 focus:outline-none focus:border-[color:var(--color-blueprint)] disabled:bg-gray-50 disabled:text-gray-500"
          value={nameDraft}
