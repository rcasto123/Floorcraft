        ...
        <ModalBody className="space-y-4 text-sm">
          ...
          <label className="block">
            ...
            <select
              ...
              disabled={busy}
              aria-label="Role"
              className="w-full rounded border border-gray-300 bg-white px-2.5 py-1.5 text-sm text-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-blueprint)] focus-visible:ring-offset-2 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 dark:focus-visible:ring-offset-gray-900 disabled:opacity-50"
            >
