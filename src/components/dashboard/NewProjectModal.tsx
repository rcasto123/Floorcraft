        ...
        <div className="grid grid-cols-2 gap-3">
          {TEMPLATES.map((t) => (
            <button
              ...
              className="flex flex-col items-start p-4 rounded-lg border border-gray-200 dark:border-gray-800 hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/40 transition-colors text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900 focus-visible:ring-[color:var(--color-blueprint)]"
            >
